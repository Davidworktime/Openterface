...
Follow our [Flatpak Installation Guide](https://github.com/TechxArtisanStudio/Openterface_QT/blob/main/docss/flatpak_installation.md) for detailed setup steps.
