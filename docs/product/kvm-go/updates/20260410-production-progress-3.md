...
draft: false
date: 2026-04-10
title: "KVM-GO Production Progress Update #3 – Production, CE/RoHS/UKCA, OSHWA, and Shipping Timeline"
description: "Third KVM-GO production update: connector batches and V1.0 boards in production prep, CE RoHS and UKCA certifications complete, OSHWA open hardware certification CN000022, HDMI-first build sequence, and revised estimates including Mouser fulfillment for first-wave HDMI."
keywords: "KVM-GO production update, KVM-GO manufacturing, KVM-GO CE RoHS UKCA, KVM-GO EMC compliance, KVM-GO OSHWA CN000022, KVM-GO open source hardware, KVM-GO HDMI VGA DisplayPort, KVM-over-USB, Openterface KVM-GO, TechxArtisan KVM-GO, KVM-GO shipping timeline, KVM-GO Mouser fulfillment"
...
social:
  ...
  title: "KVM-GO Production Progress #3 – Certifications and Timeline"
  description: "Production batches moving, CE/RoHS/UKCA and OSHWA CN000022 complete, and honest schedule update for HDMI-first shipping and Mouser delivery."
---
...
In addition to compliance certifications, KVM-GO has also been officially certified as open source hardware by **OSHWA**, with [**UID: CN000022**](https://certification.oshwa.org/cn000022.html).
